    ...
    return (
        <div className="min-h-screen bg-slate-900 text-white p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 bg-slate-800/50 p-6 rounded-xl border border-slate-700 backdrop-blur-sm">
                ...
                <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 backdrop-blur-sm">
                    ...
                    <div className="space-y-4">
                        ...
                        <AlertItem ip="10.0.0.88" type="Malware C&C" time="5h ago" />
                    </div>
                </div>
            </div>
        </div>
...
const MetricCard = ({ title, value, icon }: { title: string, value: string, icon: React.ReactNode }) => (
    <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 hover:border-purple-500/50 transition-colors backdrop-blur-sm">
...
const AlertItem = ({ ip, type, time }: { ip: string, type: string, time: string }) => (
    <div className="flex items-center justify-between p-3 bg-red-500/10 border border-red-500/20 rounded-lg hover:bg-red-500/20 transition-colors">
        <div>
